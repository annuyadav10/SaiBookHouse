...
public class Sharedpreferences {
    ...
    public  void setMobNumber(String mob){
        this.editor=this.sharedPreferences.edit();
        this.editor.putString(Constant.MobNumber,mob);
        this.editor.commit();
    }

    public String getMobNumber(){
        return this.sharedPreferences.getString(Constant.MobNumber,"");
    }
    ...
    public  void setPacakgeData(String key,String value){
        this.editor=this.sharedPreferences.edit();
        this.editor.putString(key,value);
        this.editor.commit();
    }
    public String getPackageData(String key){
        return this.sharedPreferences.getString(key,"");
    }

...
public class Constant {
    ...
    public static String MobNumber="MobNumber";
...
// for loder during fetching server data....................................................................................................
    ...
    public static Map<String, String> Headers(){
        ...
        if (BuildConfig.DEBUG) {
            ...
            fields1.put("X-API-KEY",Constant.X_API_KEY);
        }
        else {
            fields1.put("Accept", "application/json");
            fields1.put("X-API-KEY",Constant.X_API_KEY);
  ...
  public static boolean NetworkConnected(Context context) {
    ...
    public static String Decrypt(String base64value) throws Exception {
        byte[] tmp2 = Base64.decode(base64value,Base64.DEFAULT);

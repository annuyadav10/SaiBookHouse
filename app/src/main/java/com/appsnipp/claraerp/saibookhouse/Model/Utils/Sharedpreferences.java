...
public class Sharedpreferences {
    ...
    private static com.appsnipp.claraerp.saibookhouse.Utils.Sharedpreferences mSharedPref;
    ...
    public static com.appsnipp.claraerp.saibookhouse.Utils.Sharedpreferences getInstance(Context context)
    {
        if(mSharedPref == null) {
            mSharedPref = new com.appsnipp.claraerp.saibookhouse.Utils.Sharedpreferences(context);
        }
        return mSharedPref;
    }
